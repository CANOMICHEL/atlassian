...
create_user_and_database "jiradb" "secretji" "y"
create_user_and_database "confdb" "secretco" "n"
create_user_and_database "bitbucketdb" "secretbi" "n"
create_user_and_database "bitbucketdb_tmp" "secretbi" "n"
